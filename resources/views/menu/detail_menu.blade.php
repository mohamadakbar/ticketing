            ...
            <div class="x_content">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-sm-9 ">
                        <input type="text" class="form-control" disabled="disabled" value="{{ $show->nama_menu }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="control-label col-md-3 col-sm-3 ">Slug</label>
                    <div class="col-md-9 col-sm-9 ">
                        <input type="text" class="form-control" readonly="readonly" value="{{ $show->slug }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="control-label col-md-3 col-sm-3 ">As a Parent</label>
                    <div class="col-md-9 col-sm-9 ">
                        @if($show->parent == 1)
                            <input type="text" class="form-control" readonly="readonly" value="Yes">
                        @else
                            <input type="text" class="form-control" readonly="readonly" value="No">
                        @endif
                    </div>
                </div>
                <div class="form-group row">
                    <label class="control-label col-md-3 col-sm-3 ">Child of</label>
                    <div class="col-md-9 col-sm-9 ">
                        @foreach($pattern_detail as $pd)
                            <input type="text" class="form-control" readonly="readonly" value="{{ $pd->nama_menu }}">
                        @endforeach
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-sm-9 ">
                        <input type="text" class="form-control" readonly="readonly" value="{{ $show->icon }}"
                               name="icon">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-9 col-sm-9  offset-md-3">
                        ...
                        <a href="{{ url('menu/delete/') }}/{{ $show->id }}" onclick="return confirm('Are you sure?')"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="child" id="child">
                                            @foreach($pattern_detail as $pd)
                                                <option value="{{ $pd->id }}">{{ $pd->nama_menu }}</option>
                                            @endforeach
                                            @foreach($pattern as $pt)
                                                <option value="{{ $pt->id }}">{{ $pt->nama_menu }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
